...
INSERT INTO `stella`.`departamentos` (`nombre`) VALUES ('Panaderia');
INSERT INTO `stella`.`departamentos` (`nombre`) VALUES ('Lacteos');
...
INSERT INTO `stella`.`categorias` (`nombre`, `departamento_id`) VALUES ('Tes e Infusiones', 2);
INSERT INTO `stella`.`categorias` (`nombre`, `departamento_id`) VALUES ('Cafe', 2);
...
INSERT INTO `stella`.`categorias` (`nombre`, `departamento_id`) VALUES ('Jabon en Polvo', 3);
...
-- Higiene Personal (4)
INSERT INTO `stella`.`categorias` (`nombre`, `departamento_id`) VALUES ('Papel Higienico', 4);
...
INSERT INTO `stella`.`categorias` (`nombre`, `departamento_id`) VALUES ('Afeitado y Depilacion', 4);
...
-- Lácteos (8)
INSERT INTO `stella`.`categorias` (`nombre`, `departamento_id`) VALUES ('Postres Lacteos', 8);
